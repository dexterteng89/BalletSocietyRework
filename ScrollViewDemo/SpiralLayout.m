...
{
    return [SpiralLayoutAttributes class];
}
...
{
    SpiralLayoutAttributes *attributes = [SpiralLayoutAttributes layoutAttributesForSupplementaryViewOfKind:kind withIndexPath:indexPath];
